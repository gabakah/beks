...
function printImage ($linkImg, $imgID, $linkUrl)
{
	...
	$onPage=(strcasecmp($scriptName,$linkUrl)==0);
	
	if (strcasecmp($scriptName,"index.php")==0
		&& strcasecmp($linkUrl,"http://www.braatpaq.com")==0)
		$onPage=TRUE;
	
	echo "<tr><td height=\"25\" id=\"" . $imgID . "TD\"";
	if ($onPage)
		echo " class=\"greyedLink\" bgcolor=\"#85A168\"";
	echo ">";
	if (!$onPage)
...
?>
	...
	<table cellspacing="0" cellpadding="0">
		<?printImage("home", "homeImage", "http://www.braatpaqbags.com")?>
		<?printBlankRow()?>
		...
		<?printBlankRow()?>
  		<?printImage("faqs", "faqsImage", "faq.php")?>
		<?printBlankRow()?> 
		<?printImage("affiliates", "affiliatesImage", "affiliate.php")?>
	</table>
<?
}
?>
